...
<div class="container mysqlGalerija">
    ...
    $nuotrauka = getNuotrauka('renginiai');
...
<div class="col-md-<?php echo $vienaNuotrauka['atributas'];?> col-md-offset-<?php echo $vienaNuotrauka['atitraukimas'];?> img-fluid">
    <img class='materialboxed' data-caption="<?php echo $vienaNuotrauka['aprasymas']?>" src="./img/renginiai/<?php echo $vienaNuotrauka['linkas']?>.jpg" width="100%" alt="">
</div>

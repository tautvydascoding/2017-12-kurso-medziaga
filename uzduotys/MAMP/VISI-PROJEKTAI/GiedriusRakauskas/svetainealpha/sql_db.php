...
//lietuviu kalbos ijungimas
//1)nurodyti database faile, kur mysql komandos mysqli_set_charset($prisijungimas, 'utf8');
//2)headeryje nurodyti utf-8
//3
...
// function getDoctors( ) {
//     $sql_tekstas = "SELECT * FROM LIMIT 6;";  // ORDER BY property ----- pakeicia rikiavimo parametra LIMIT *--- nurodo limita,kiek atspausdina
//     $rezultatai = mysqli_query(getPrisijungimas(), $sql_tekstas);
//     return $rezultatai;
// }
// getDoctors();

function getNuotrauka() {
    $sql_tekstas = "SELECT * FROM gamta;";
    $rezultatas = mysqli_query(getPrisijungimas(), $sql_tekstas);
    return $rezultatas;
}
//====================BANDAU CREATE FORMA ZMOGAUS===============//
//================================================================//

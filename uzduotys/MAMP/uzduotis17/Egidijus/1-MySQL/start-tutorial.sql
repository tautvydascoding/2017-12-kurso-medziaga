...
use hospital12; // nurodome darbine duomenu base (DB)
 ...
 use hospital10;
  ...
  CREATE TABLE patients (
    ...
    INSERT INTO patients  VALUES  ('', 'Mark', 'Jonon' , '2' );
 	...
 	INSERT INTO patients  VALUES  ('', 'Aris', 'Neno' , '1' );
 	INSERT INTO patients  VALUES  ('', 'Tom', 'Kapos' , '3' );
 	INSERT INTO patients  VALUES  ('', 'Co', 'Neno' , '1' );
 	INSERT INTO patients  VALUES  ('', 'Tom', 'Joto' , '5' );
 ...
 DELETE FROM patients where id = 4;
  ...
  Create TABLE `patients` ( id INT(6) AUTO_INCREMENT PRIMARY KEY, name VARCHAR(25), lname VARCHAR(35) );
   ...
   Create TABLE `img` ( id INT(6) AUTO_INCREMENT PRIMARY KEY, name VARCHAR(80), client_id int(6) );
  ...
  INSERT INTO img  VALUES  ('', 'foto.png', '1');
  INSERT INTO img  VALUES  ('', 'As.jpg', '2');
